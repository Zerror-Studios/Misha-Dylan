...
//     <div className="hero-img-1 absolute top-0 right-0 w-full h-screen  overflow-hidden z-0">
//       <img
//       // style={{filter: "brightness(0.7)"}}
//         src="/FinalImage/1.webp"
//         alt="Florence"
//         className="w-full h-full object-cover object-[50%_58%] scale-[1.08] z-[-1]"
//       />
//     </div>
...
//     <div className="relative z-20  m-auto flex flex-col justify-center items-center">
//       <div className="overflow-hidden mb-1">
//         <h2 className="hero-title-word Font_Q COLOR_TEXT_RED uppercase">
//           Explore Florence
//         </h2>
//       </div>
...
//       <div className="hero-sub flex items-start gap-12 mt-5 max-w-[500px]">
        
//         <div className="flex flex-col gap-3">
//           <p className=" COLOR_TEXT_RED Font_Q text-center leading-relaxed ">
...
//           </p>
//           <p className=" COLOR_TEXT_RED Font_Q text-center">
//             All travel times are approximate from Florence's historic centre (Duomo area).
//           </p>
//         </div>
//       </div>
...
//       />
//       <p className=" tracking-[0.5em] uppercase Font_Q COLOR_TEXT_RED  shrink-0">
//         {category}
//       </p>
//       <div
...
//           {/* Body */}
//           <p className=" COLOR_TEXT_RED Font_YV leading-relaxed max-w-[380px]">
//             {section.body}
//           </p>
...
const SectionBlock = ({ section, index }) => {
  ...
  return (
    <section className="w-full px-6 md:px-[6vw] py-12 md:py-24 relative">
      ...
      <div
        className={`section-number hidden md:block absolute top-8 ${isLeft ? "right-[6vw]" : "left-[6vw]"} Font_Q COLOR_TEXT_RED leading-none select-none pointer-events-none`}
        style={{
          opacity: 0.04,
          ...
          <div className="w-full md:w-[52%] flex gap-3 md:gap-4 shrink-0">
            {section.images[0] && (
              ...
              >
                ...
                <div className="aspect-[2/3] md:aspect-[3/4] w-full overflow-hidden">
                  <Image
                    src={section.images[0].src}
                    alt={section.images[0].alt}
                    width={800}
            ...
            {section.images[1] && (
              ...
              >
                <div
                  className="aspect-[2/3] md:aspect-[3/4] w-full overflow-hidden"
